...
describe('Test the route of api/items', () => {
  ...
  it('should respond with unauthorized when no data or token provided', async done => {
    const res = await request(app).post('/api/items/');
    expect(res.status).toBe(401);
    done();
  });

  it('should respond with an unprocessable entity when no data provided but sent with token', async done => {
  ...
  it('should not add an item when a required field is blank and sent with token', async done => {
    // A post request without any data shold not pass vaildation
    const validUser = {
      name: 'Test User',
      email: 'test.user@email.com',
  ...
  it('should save a new item to the database', async done => {
    const validUser = {
      name: 'Test User',
      email: 'test.user@email.com',
      password: 'somepassword'
  ...
  it('should update an existing item in the database', async done => {
    const validUser = {
      name: 'Test User',
      email: 'test.user@email.com',
      password: 'somepassword'
  ...
  it('should not update an existing item without proper modified data', async done => {
    const validUser = {
      name: 'Test User',
      email: 'test.user@email.com',
      password: 'somepassword'
  ...
  it('should not delete an item from the database without a proper ID', async done => {
    const validUser = {
      name: 'Test User',
      email: 'test.user@email.com',
      password: 'somepassword'
  ...
  it('should get a list of items from the database without previous or next in pagination', async done => {
    // Create an item with valid data
    const validItems = [
      {
  ...
  it('should get a paginated list of items with default pagination parameters', async done => {
    // Create an item with valid data
    const validItems = [
      {
        description: 'A test description 1',
  ...
  it('should get a specific page of items from the database', async done => {
    // Create an item with valid data
    const validItems = [
      {
        description: 'A test description 1',
  ...
  it('should send back the last valid previous page if the current page is beyond the pagination limit', async done => {
    // Create an item with valid data
    const validItems = [
      {
        description: 'A test description 1',
  ...
  it('should respond with a bad request if pagination parameters are invalid', async done => {
    // Create an item with valid data
    const validItems = [
      {
        description: 'A test description 1',
