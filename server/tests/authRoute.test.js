...
describe("Test the route of api/auth", () => {
  ...
  it("should authenticate a valid email and vaild password", async () => {
    const validUser = {
      name: "Test User",
    ...
    const res = await request(app).post("/api/auth/").send(loginData);
  ...
  it("should not pass validation without providing an email or password", async () => {
    const loginData = {
      email: null,
      password: null,
    };
  ...
  it("should not authenticate a non-existant user email", async () => {
    const loginData = {
  ...
  it("should not authenticate an invalid password with a valid email", async () => {
    const validUser = {
      name: "Test User",
      email: "test.user@email.com",
      password: "somepassword",
  ...
  it("should not authenticate an existing user with an invalid token", async () => {
    const validUser = {
      name: "Test User",
      email: "test.user@email.com",
      password: "somepassword",
  ...
  it("should not authenticate an existing user without providing a token", async () => {
    const validUser = {
      name: "Test User",
      email: "test.user@email.com",
      password: "somepassword",
